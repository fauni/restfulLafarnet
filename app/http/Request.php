...
class Request
{
    ...
    /**
     * Constructor
     * @param \App\Environment $env
     */
    public function __construct(\App\Environment $env)
    {
        $this->env = $env;
        $this->headers = new \App\Http\Headers(\App\Http\Headers::extract($env));
        $this->cookies = new \App\Helper\Set(\App\Http\Util::parseCookieHeader($env['HTTP_COOKIE']));
    }
    ...
    /**
     * Fetch PUT data (alias for \App\Http\Request::post)
     * @param  string           $key
    ...
    /**
     * Fetch PATCH data (alias for \App\Http\Request::post)
     * @param  string           $key
     * @param  mixed            $default Default return value when key does not exist
     * @return array|mixed|null
     */
    ...
    /**
     * Fetch DELETE data (alias for \App\Http\Request::post)
     * @param  string           $key
     * @param  mixed            $default Default return value when key does not exist
     * @return array|mixed|null
     */
