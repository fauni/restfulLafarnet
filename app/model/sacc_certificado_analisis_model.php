...
class SaccCertificadoAnalisisModel
{
    ...
    public function GetAllPT()
    {
		try
        {
            ...
            $stm = $this->db->prepare("SELECT * FROM sacc_certificado_analisis WHERE tipo_certificado= 'Producto Terminado' order by fecha_analisis desc");
            $stm->execute();
    ...
    public function GetAllMP()
    {
		try
        {
            ...
            $stm = $this->db->prepare("SELECT * FROM sacc_certificado_analisis WHERE tipo_certificado= 'Materia Prima' order by fecha_analisis desc");
            $stm->execute();
